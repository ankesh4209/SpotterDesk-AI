...
export default function Automations() {
  ...
  return (
    <section className="bg-white py-16 sm:py-20 md:py-28 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-10 sm:mb-14 md:mb-20 text-center max-w-2xl mx-auto"
        >
          ...
          {automationItems.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="relative p-5 sm:p-8 bg-slate-50/80 hover:bg-white border border-slate-200/80 hover:border-indigo-200 rounded-2xl sm:rounded-3xl transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 group flex flex-col justify-between"
              >
                <div>
                  {/* Icon */}
